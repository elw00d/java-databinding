...
public class BindingGroup {
     ...
     */
    public BindingGroup(INotifyPropertyChanged source, BindingSettings settings) {
        this(source);
        if (null == settings) throw new IllegalArgumentException("settings is null");
        this.settings = settings;
    }

    public BindingSettings getSettings() {
        return settings;
    }
     ...
     */
    public void setSettings(BindingSettings settings) {
        if (null == settings) throw new IllegalArgumentException( "settings is null" );

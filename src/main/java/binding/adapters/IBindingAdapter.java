...
public interface IBindingAdapter<TTarget> {
     ...
     */
    Class<TTarget> getTargetClazz();

    /**
     * Returns class object of virtual property that can be used as binding Target.
     */
    Class<?> getTargetPropertyClazz(String targetProperty);
     ...
     */
    <TValue> void  setValue( TTarget target, String targetProperty, TValue value);
     ...
     * @param <TValue> Value type argument
     */
    <TValue> TValue getValue( TTarget target, String targetProperty);
